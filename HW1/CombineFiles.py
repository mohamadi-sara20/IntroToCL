...
if not os.path.exists("E:\CL\Semester2\IntrotoCL\HW\HW1\MergedFolders"):
    os.makedirs("E:\CL\Semester2\IntrotoCL\HW\HW1\MergedFolders")


for i in range(len(paths)):
    with open("E:\CL\Semester2\IntrotoCL\HW\HW1\MergedFolders\Merged " +  str(i+1) + ".txt", "w", encoding= "UTF8") as f:
        f.write(CombineFiles(paths[i]))


if not os.path.exists("E:\CL\Semester2\IntrotoCL\HW\HW1\MergedAll"):
    os.makedirs("E:\CL\Semester2\IntrotoCL\HW\HW1\MergedAll")


with open("E:\CL\Semester2\IntrotoCL\HW\HW1\MergedAll\MergedAll.txt", "w", encoding = "UTF8") as h:
    h.write(CombineFiles("E:\CL\Semester2\IntrotoCL\HW\HW1\MergedFolders"))
